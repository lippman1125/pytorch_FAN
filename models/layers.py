...
class RNN(nn.module):
    def __init__(self, input_size, hidden_size, output_size):
        ...
        self.i2h = nn.Conv2d(input_size + hidden_size, hidden_size, 3, 1, 1)
        self.i2o = nn.Conv2d(input_size + hidden_size, output_size, 3, 1, 1)

    def forward(self, input, hidden):
        combined = torch.cat((input, hidden), 1) # channel-wise
