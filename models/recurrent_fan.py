    ...
    def __init__(self,
        ...
        for i in range(num_stacks):
            ...
            if not use_attention:
                ...
                score.append(
                    nn.Sequential(
                        attentionCRF(ch, 3, 3, False), nn.Conv2d(ch, num_classes, 1, bias=True)))
            else:
                score.append(
                    nn.Sequential(attentionCRF(ch, 3, 3, False), attentionCRF(ch, 3, 3, True)))
